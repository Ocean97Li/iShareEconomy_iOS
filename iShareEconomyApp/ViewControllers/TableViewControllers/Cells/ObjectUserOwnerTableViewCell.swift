...
class ObjectUserOwnerTableViewCell: UITableViewCell {
    ...
    func update(id: String, name: String, subtitle: String?, owner: Bool, info: Bool) {
        objectUserOwnerView.update(id: id, name: name, subtitle: subtitle, owner: owner, info: info)
    }
}
